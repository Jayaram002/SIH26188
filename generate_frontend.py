...
write_file("src/services/demoData.ts", """
  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        destructive: "bg-highrisk text-white hover:bg-highrisk-dark",
        outline: "border border-border-primary bg-transparent hover:bg-panel-hover",
        secondary: "bg-panel-card text-white hover:bg-panel-hover",
        ghost: "hover:bg-panel-hover hover:text-white",
...
const Login = () => <div className="text-white">Login</div>
